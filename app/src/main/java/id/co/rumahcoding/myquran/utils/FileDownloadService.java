...
public class FileDownloadService extends IntentService {
    ...
    private static final String ZIP_FILENAMES = "zip_filenames";
    ...
    public void downloadCompleted(ResultReceiver resultReceiver, ArrayList<String> filenames) {
        Bundle progressBundle = new Bundle();
    ...
    private ArrayList<String> unzip(String zipFilePath, String unzipAtLocation) throws Exception {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == FileDownloadService.STATUS_OK) {
                ...
                if (resultData.containsKey(FileDownloadService.DOWNLOAD_STARTED)
                    ...
                    List<String> filenames = resultData.getStringArrayList(FileDownloadService.ZIP_FILENAMES);
    ...
    public static interface OnDownloadStatusListener {
        ...
        void onDownloadCompleted(List<String> filenames);
